...
$db['user'] = "ユーザー名";  // ユーザー名
$db['pass'] = "ユーザー名のパスワード";  // ユーザー名のパスワード
        ...
        try {
            ...
            if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                if (password_verify($password, $row['password'])) {
                    ...
                    header("Location: https://ユーザー名.tech-base.net/mission_6_main.php");  // メイン画面へ遷移
                    exit();  // 処理終了
                } else {
                    // 認証失敗
...
<html>
    ...
    <body>
        ...
        <br>
        <form action="https://ユーザー名.tech-base.net/mission_6_SignUp.php">
            <fieldset>          
